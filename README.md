...
/
├── index.html → de tool zoals hij draait (de nieuwe schil)
├── index-oud.html → de vorige interface, bewaard als terugvaloptie
├── schil.css / schil.js → opmaak en presentatielaag van index.html
├── kernadapter.js → vertaalt tussen de interface en de rekenkern
├── schil/ → het originele ontwerp, ongewijzigd, draait niet
├── styles.css → opmaak van index-oud.html
├── calc.js → de rekenkern, plus de interface van index-oud.html
